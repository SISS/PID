...
// - stops queues of now-redundant requests building up / allows you to supersede one request with another easily.
...
Ajax.Responders.register({
	onCreate: function(request)
	{
		...
		// keep note of this request object so we can cancel it if superseded
